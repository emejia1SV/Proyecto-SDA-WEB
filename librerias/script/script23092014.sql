--------------------------------------------------------
-- ARCHIVO CREADO  jueves-septiembre-23-2014   
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SQ_SDA_LOG_DEPURACION"  MINVALUE 1 MAXVALUE 100000000 INCREMENT BY 1 START WITH 1 NOCACHE  ORDER  NOCYCLE ;
