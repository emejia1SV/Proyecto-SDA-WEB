...
--------------------------------------------------------
DROP TABLE "CLIENTE_TEL";
DROP TABLE "HABITANTES";
DROP TABLE "SDA_AGREGADORES";
DROP TABLE "SDA_CAT_RESPUESTAS";
DROP TABLE "SDA_CAT_RESULTADOS";
DROP TABLE "SDA_LOG_DEPURACION";
DROP TABLE "SDA_METODOS";
DROP TABLE "SDA_PAISES";
DROP TABLE "SDA_PARAMETROS";
DROP TABLE "SDA_PARAMETROS_SISTEMA";
DROP TABLE "SDA_RESPUESTAS";
DROP TABLE "SDA_RESULTADOS_RESPUESTA";
DROP TABLE "SDA_USUARIO_SISTEMA";
...
REM INSERTING into HABITANTES
SET DEFINE OFF;
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000001','Patricia','Sanchez','H');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000002','Isabel','Reyes','D');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000003','Deysi','siliezar','D');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000004','Angela','Ruano','D');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000005','Margarita','Alvarado','H');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000006','Claudia','Siliezar','D');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000007','Lucia','Palacios','D');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000008','Matilde','Cubias','H');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000009','Anotonio','Alfaro','H');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000010','Maria','Chicas','H');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000011','Juana','Hernandez','D');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000012','Yolanda','Hernandez','D');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000013','Norma','Hernandez','D');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000014','Roman','Hernandez','H');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000015','Claudia','Hernandez','D');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000016','Victor','Lira','D');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000017','Ana','Ramirez','H');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000018','julio','Iraheta','D');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000019','Elmer','Alas','H');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000020','Marta','Martinez','D');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000021','Laura Duran','Duran','H');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000022','Douglas','Mejia','D');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000023','Edwin','Mejia','D');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000024','Grupo','24 de Septiembre','H');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000025','Ernesto','Sanchez','H');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000026','Orlando','Bonilla','D');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000027','Demetrio','Lopez','D');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000028','Gloria','Perez','D');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000029','Veronica','Estrada','H');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000030','Santana','Reyes','H');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000031','Eliza','Hernandez','H');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000032','Julia','Monterroza','H');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000033','Marlo','Monterroza','D');
Insert into HABITANTES (HABITANTES_ID,NOMBRES,APELLIDOS,CARGO) values ('00000034','Guadalupe','Vega','H');
